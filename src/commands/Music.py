#Pulled from; https://gist.github.com/vbe0201/ade9b80f2d3b64643d854938d40a0a2d
import asyncio
import functools
import itertools
import math
...
#Silence useless bug report messages... :eyes:
...
class Music(commands.Cog):
    ...
    async def _volume(self, ctx: commands.Context, *, volume=50):
        """Sets the volume of the player."""
        if len(ctx.message.content) == len(self.bot.command_prefix + "volume"):
            return await ctx.send('Current volume is set at: ' + str(int(ctx.voice_state.volume * 100)) + "%")
